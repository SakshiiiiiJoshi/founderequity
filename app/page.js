  ...
  return (
    <div className="flex min-h-screen flex-col bg-background font-sans text-foreground selection:bg-accent-light selection:text-primary">
      ...
      <main className="flex-grow">
        ...
        <section id="about" ref={aboutRef} className="py-20 px-6 sm:px-8 lg:px-12 lg:py-28 border-t border-black/5 bg-[#A8B5C5] overflow-hidden">
          <div className="mx-auto max-w-7xl">
            
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              
              {/* Left Column: Integrated Stats Dashboard Widget */}
              <div className={`lg:col-span-5 w-full flex justify-center lg:justify-start transition-all duration-1000 ease-out transform ${
                isAboutVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"
              }`}>
                <div className="w-full max-w-[420px] p-8 rounded-3xl bg-white/80 border border-white/90 shadow-[0_20px_50px_rgba(13,27,42,0.06)] backdrop-blur-md">
                  <p className="text-xs font-bold uppercase tracking-widest text-[#0D1B2A]">
                    Our Impact
                  </p>
                  <h4 className="font-serif-heading text-2xl font-extrabold text-[#0D1B2A] mt-2">
                    Our Advisory Funds Over Time
                  </h4>
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-6 border-t border-black/5 pt-6">
                    <div>
                      <p className="text-3xl font-sans font-extrabold text-[#0D1B2A] tracking-tight">$35M</p>
                      <p className="text-[10px] font-bold text-slate-700 uppercase tracking-wider mt-1">Fund I (2024)</p>
                    </div>
                    <div>
                      <p className="text-3xl font-sans font-extrabold text-[#0D1B2A] tracking-tight">$55M</p>
                      <p className="text-[10px] font-bold text-slate-700 uppercase tracking-wider mt-1">Fund II (2025)</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={`lg:col-span-7 w-full flex flex-col justify-center transition-all duration-1000 ease-out transform ${
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="group relative flex items-start gap-5 p-5 rounded-2xl border border-white/30 bg-white/80 hover:bg-white/95 hover:border-white/50 transition-all duration-300 shadow-sm hover:shadow-md">
                    {/* Left accent glowing bar */}
                    <div className="absolute left-0 top-4 bottom-4 w-[3px] rounded-r bg-[#0D1B2A]/10 group-hover:bg-[#0D1B2A] group-hover:shadow-[0_0_12px_rgba(13,27,42,0.4)] transition-all duration-300"></div>
                    
                    {/* Number Badge with subtle glow */}
                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-white/80 border border-white/50 text-xs font-bold text-[#0D1B2A] group-hover:bg-[#0D1B2A] group-hover:text-white group-hover:border-transparent transition-all duration-300">
                      01
                    </span>
                    
                    <div>
                      <h4 className="font-sans text-sm font-bold text-[#0D1B2A] tracking-wide">
                        <span className="text-[#1D3058] group-hover:text-black transition-colors duration-300">Ambitious startups.</span> Investor-ready numbers.
                      </h4>
                      <p className="mt-2 text-xs text-slate-800 leading-relaxed group-hover:text-black transition-colors duration-300">
                  ...
                  <div className="group relative flex items-start gap-5 p-5 rounded-2xl border border-white/30 bg-white/80 hover:bg-white/95 hover:border-white/50 transition-all duration-300 shadow-sm hover:shadow-md">
                    ...
                    <div>
                      <h4 className="font-sans text-sm font-bold text-[#0D1B2A] tracking-wide">
                        <span className="text-[#1D3058] group-hover:text-black transition-colors duration-300">Strong businesses.</span> Hidden value.
                      </h4>
                      <p className="mt-2 text-xs text-slate-800 leading-relaxed group-hover:text-black transition-colors duration-300">
                  ...
                  <div className="group relative flex items-start gap-5 p-5 rounded-2xl border border-white/30 bg-white/80 hover:bg-white/95 hover:border-white/50 transition-all duration-300 shadow-sm hover:shadow-md">
                    ...
                    <div>
                      <h4 className="font-sans text-sm font-bold text-[#0D1B2A] tracking-wide">
                        <span className="text-[#1D3058] group-hover:text-black transition-colors duration-300">Stories inspire.</span> Numbers convince.
                      </h4>
                      <p className="mt-2 text-xs text-slate-800 leading-relaxed group-hover:text-black transition-colors duration-300">
                ...
                <div className="mt-10 grid grid-cols-3 gap-6 border-t border-white/30 pt-8">
                  <div>
                    <p className="text-3xl md:text-5xl font-sans font-extrabold text-[#0D1B2A] tracking-tight">$90M+</p>
                    <p className="text-[10px] font-semibold text-slate-700 mt-1 uppercase tracking-wider leading-tight">Assets under advisory</p>
                  </div>
                  <div>
                    <p className="text-3xl md:text-5xl font-sans font-extrabold text-[#0D1B2A] tracking-tight">25+</p>
                    <p className="text-[10px] font-semibold text-slate-700 mt-1 uppercase tracking-wider leading-tight">Transactions completed</p>
                  </div>
                  <div>
                    <p className="text-3xl md:text-5xl font-sans font-extrabold text-[#0D1B2A] tracking-tight">18+</p>
                    <p className="text-[10px] font-semibold text-slate-700 mt-1 uppercase tracking-wider leading-tight">Years of experience</p>
                  </div>
                </div>
        ...
        {/* Service Section */}
        <section id="service" className="bg-[#0B1420] py-20 px-6 sm:px-8 lg:px-12 lg:py-28">
          <div className="mx-auto max-w-7xl">
            {/* Header */}
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-2xl border border-palette-slate bg-palette-ice p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white text-[#0D1B2A] border border-subtle">
        ...
        {/* Contact Us Section */}
        <section id="contact" className="py-20 px-6 sm:px-8 lg:px-12 lg:py-28 bg-[#A8B5C5]">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between">
                <div>
                  <h2 className="text-xs font-bold uppercase tracking-widest text-[#0D1B2A]">Inquiries</h2>
                  <p className="font-serif-heading mt-3 text-3xl font-bold tracking-tight text-[#0D1B2A] sm:text-4xl">
                    Get in Touch
                  </p>
                  <p className="mt-4 text-slate-800 max-w-md">
                  ...
                  <div className="mt-10 space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/40 text-[#0D1B2A] border border-white/60">
                        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <div>
                        <p className="text-xs text-slate-700 uppercase tracking-wider font-semibold">Email</p>
                        <a href="mailto:advisory@foundersequity.com" className="text-sm font-semibold text-[#0D1B2A] hover:underline">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-slate-700 uppercase tracking-wider font-semibold">Location</p>
                        <p className="text-sm font-semibold text-[#0D1B2A]">San Francisco, CA &amp; New York, NY</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-palette-slate bg-palette-ice p-6 shadow-lg sm:p-8">
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                          ...
                          <input
                            ...
                            className="mt-2 w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-palette-sky focus:bg-white/10 focus:outline-none"
                      ...
                      <button
                        type="submit"
                        className="w-full rounded-full bg-white py-4 text-xs font-bold uppercase tracking-wider text-[#0D1B2A] shadow-md transition-all hover:bg-neutral-100 hover:shadow-lg focus:outline-none"
                      >
                        Send Message
                      </button>
                    </form>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-12 md:gap-12">
            ...
            <div className="md:col-span-3">
              <h4 className="text-xs font-bold uppercase tracking-wider text-palette-sky">Website</h4>
            ...
            {/* Office Info (Right) */}
            <div className="md:col-span-3">
              <h4 className="text-xs font-bold uppercase tracking-wider text-palette-sky">Office Contact</h4>
